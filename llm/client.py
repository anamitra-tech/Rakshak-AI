...
# llama-3.1-8b-instant 404s on this account (2026-09-11 audit) -- Groq's own
# docs still list it, but GET /openai/v1/models against the real key shows
# no Llama chat models on this account at all anymore (only a
# meta-llama/llama-prompt-guard-2-* classifier, not usable for generation).
# openai/gpt-oss-20b is confirmed live-working against the real key/account.
